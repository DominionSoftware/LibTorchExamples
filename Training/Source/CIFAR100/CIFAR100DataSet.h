...
namespace torch_explorer
{
    ...
    class CIFAR100DataSet : public IDataSet<CIFAR100>
    {
    public:


        CIFAR100DataSet() : IDataSet<CIFAR100>(),is_train(false)
        {
        ...
        explicit CIFAR100DataSet(bool is_training) : IDataSet<CIFAR100>(), is_train(is_training)
        {
            options = torch::data::DataLoaderOptions()
                .batch_size(32)
                .workers(2);
